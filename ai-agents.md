...
Auto-passed to container: `ANTHROPIC_API_KEY`, `OPENAI_API_KEY`, `AWS_ACCESS_KEY_ID`, `AWS_SECRET_ACCESS_KEY`, `CLAUDE_CODE_USE_BEDROCK`, `DEEPSEEK_API_KEY`, `GEMINI_API_KEY`, `CURSOR_API_KEY`, `AMP_API_KEY`, `FACTORY_API_KEY`, `MISTRAL_API_KEY`.
